...
export async function getFeaturedCars(limit = 3) {
  try {
    ...
    throw new Error("Error fetching featured cars: " + String(error));
  }
}
 ...
 */
export async function processImageSearch(base64Image: string,
    mimeType: string) {
  try {
    ...
    throw new Error("AI Search error: " + String(error));
  }
}
